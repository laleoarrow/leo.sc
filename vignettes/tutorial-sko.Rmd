...
# Pick a target gene: any gene expressed in at least some cells.
# Here we choose NKG7 for illustration; users can substitute any gene of interest.
gene_use <- "NKG7"
gene_use
```
...
confounding by cell-type abundance:
