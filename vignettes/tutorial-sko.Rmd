...
qs_file <- system.file("extdata", "1.LRRK2_ko_res.qs", package = "leo.sc")
res <- qs::qread(qs_file)
...
> directly validating FIP's prediction of antigen binding as the top enriched
