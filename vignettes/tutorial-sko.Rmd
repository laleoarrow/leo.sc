...
> **⚠️ Method accuracy note:** `pbmc_small` contains only 80 cells and is used here **purely for a reproducible, dependency-free demo**. DEG and enrichment results are statistically underpowered and should **not** be interpreted biologically. For a realistic FIP run with meaningful enrichment output, see the [**PBMC3k case study →**](tutorial-sko-pbmc3k.html).
